    ...
    <nav className="flex items-center justify-between flex-wrap p-4 h-full w-full bg-purple-950 rounded-b-lg">
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <div className="text-sm flex lg:flex-grow">
          <Link
            to="/"
            className="flex mt-4 gap-1 leading-5 lg:mt-0 text-white hover:text-purple-500 mr-4"
          >
            Home {<HomeIcon className="size-5" />}
          </Link>
          <a
            href="#responsive-header"
            className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-purple-500 mr-4"
          >
            Learn More
          </a>
          <Link
            ...
            className="flex mt-4 gap-1 leading-5 lg:mt-0 text-white hover:text-purple-500 mr-4"
          >
            Chat {<ChatBubbleLeftRightIcon className="size-5" />}
          </Link>
        </div>
        <div>
          <a
        ...
        <div>
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="size-6 text-white hover:text-purple-500"
          >
            <path
              strokeLinecap="round"
